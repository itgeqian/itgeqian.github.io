...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | geqian's Blog🍋")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by geqian🍋 %c 你正在访问geqian🍋の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| geqian🍋") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('geqian🍋的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://java-geqian.oss-cn-beijing.aliyuncs.com/%E6%B7%B1%E6%B8%8A.jpg);
    --darkmode-bg:url(https://java-geqian.oss-cn-beijing.aliyuncs.com/%E4%BC%8A%E8%8A%99%E7%90%B3%E5%A4%9C%E8%89%B2.jpg);
    --mobileday-bg: url(https://java-geqian.oss-cn-beijing.aliyuncs.com/%E6%82%B2%E4%BC%A4%E5%B0%8F%E7%8E%A5%2Cpng);
    --mobilenight-bg: url(https://java-geqian.oss-cn-beijing.aliyuncs.com/%E8%8A%99%E5%AE%81%E5%A8%9C.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
